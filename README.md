...
1. Initialize your local repository:
    ```bash
    repo init --no-repo-verify --git-lfs -u https://github.com/Porter-union-rom-updates/manifest -b QPR3 -g default,-mips,-darwin,-notdefault
    ```
   Or If you wish to save some system space and don't care about repo history depths:
    ```bash
    repo init --depth=1 --no-repo-verify --git-lfs -u https://github.com/Porter-union-rom-updates/manifest -b QPR3 -g default,-mips,-darwin,-notdefault
    ```
